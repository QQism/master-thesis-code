...
generate_task3_dataset <- function()
{
  ...
  radius_levels <- 4
  fov_levels <- 2
  datasets_count <- task3_repetition * vis_levels * radius_levels * fov_levels * 2
  ...
  for (rep in 0:(task3_repetition-1))
  {
    ...
    for (r in 0:1)
    {
      ...
      for (id in 1:3)
      {
        questions[id*8*task3_repetition-(8 * task3_repetition - 1)+(task3_repetition*2)+r*task3_repetition+rep, 3:4] <- c(radius1, radius2)
      }
    }
    ...
    for (r in 0:1)
    {
      ...
      for (id in 1:3)
      {
        questions[id*8*task3_repetition-(8 * task3_repetition - 1)+(task3_repetition*2*2)+r*task3_repetition+rep, 3:4] <- c(radius1, radius2)
      }
    }
    ...
    for (r in 0:1)
    {
      ...
      for (id in 1:3)
      {
        questions[id*8*task3_repetition-(8 * task3_repetition - 1)+(task3_repetition*2*3)+r*task3_repetition+rep, 3:4] <- c(radius1, radius2)
      }
    }
    ...
    for (r in 0:3)
    {
      ...
      for (id in 1:3)
      {
        idx <- id*8*task3_repetition-(8 * task3_repetition - 1)+r*2*task3_repetition+rep
        questions[idx, 5] <- fov
    ...
    for (r in 0:3)
    {
      ...
      for (id in 1:3)
      {
        idx <- id*8*task3_repetition-(8 * task3_repetition - 1)+r*2*task3_repetition+task3_repetition+rep
        questions[idx, 5] <- fov
        questions[idx, 8] <- rep+1
      }
    }
    ...
    for (r in 1:8)
    {
      ...
      for (id in 1:3)
      {
        idx <- id*8*task3_repetition-(8 * task3_repetition - 1)+r*task3_repetition-task3_repetition+rep
